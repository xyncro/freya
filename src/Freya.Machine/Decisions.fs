...
let private publicDecisionDefinitions =
    [ Decisions.Allowed,                        true,                           (Decisions.ContentTypeValid,                Operations.PreForbidden)
      ...
      Decisions.CharsetsStrict,                 false,                          (Operations.PreNotAcceptable,               Decisions.EncodingRequested)
      ...
      Decisions.EncodingsStrict,                false,                          (Operations.PreNotAcceptable,               Decisions.Processable)
      ...
      Decisions.LanguagesStrict,                false,                          (Operations.PreNotAcceptable,               Decisions.CharsetRequested)
      Decisions.Malformed,                      false,                          (Operations.PreMalformed,                   Decisions.Authorized)
      Decisions.MediaTypesStrict,               true,                           (Operations.PreNotAcceptable,               Decisions.LanguageRequested)
